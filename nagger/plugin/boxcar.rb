...
module Nagger::Plugin
    ...
    class Boxcar
        def initialize(config)
            Nagger::Util.debug("Creating new insance of Boxcar plugin")
        ...
        def self.register
            Nagger::Util.register_plugin("boxcar", "Boxcar")
        end
        ...
        def send(recipient, subject, msg)
            ...
            begin
                ...
                if res.code == 200
                    ...
                    raise(Nagger::PluginConnectionError, "Could not send message, api code: #{res.code}")
                end
            rescue Exception => e
